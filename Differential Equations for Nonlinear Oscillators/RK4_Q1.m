function [ t,x,y ] = RK4_Q1(a,b,h,N)
%RK4_Q1 takes as input the parameters a and b of the forced Duffing eqn.
...
xlabel('x')
ylabel('dx/dt')
title(['Five random trajectories for a='  num2str(a) ' and b='  num2str(b)])
hold off
